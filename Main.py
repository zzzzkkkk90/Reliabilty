...
def sum_cols(matrix):
    ...
    length = len(sum_col_list1)
    ans = [i / length for i in sum_col_list1]
    return ans
...
def bootstrap(dataset):
    ...
    rus_ltr_ranking = PerformanceMeasure(
        testing_data_y, rus_ltr_pred_y).ranking()
    ...
    rus_rs_ranking = PerformanceMeasure(
        testing_data_y, rus_rs_pred_y).ranking()
    ...
    rus_dtr_ranking = PerformanceMeasure(
        testing_data_y, rus_dtr_pred_y).ranking()
    ...
    rus_lr_ranking = PerformanceMeasure(
        testing_data_y, rus_lr_pred_y).ranking()
    ...
    rus_brr_ranking = PerformanceMeasure(
        testing_data_y, rus_brr_pred_y).ranking()
    ...
    smote_X, smote_y = Smote(
        training_data_X, training_data_y, ratio=1.0, k=5).over_sampling_addorginaldata()
    ...
    smote_ltr_pofb = PerformanceMeasure(
        testing_data_y, smote_ltr_pred_y).PofB20()
    smote_ltr_pofd = PerformanceMeasure(
        testing_data_y, smote_ltr_pred_y).PofD20()
    smote_ltr_ranking = PerformanceMeasure(
        testing_data_y, smote_ltr_pred_y).ranking()
    ...
    smote_rs_pofb = PerformanceMeasure(
        testing_data_y, smote_rs_pred_y).PofB20()
    smote_rs_pofd = PerformanceMeasure(
        testing_data_y, smote_rs_pred_y).PofD20()
    smote_rs_ranking = PerformanceMeasure(
        testing_data_y, smote_rs_pred_y).ranking()
    ...
    smote_dtr_pofb = PerformanceMeasure(
        testing_data_y, smote_dtr_pred_y).PofB20()
    smote_dtr_pofd = PerformanceMeasure(
        testing_data_y, smote_dtr_pred_y).PofD20()
    smote_dtr_ranking = PerformanceMeasure(
        testing_data_y, smote_dtr_pred_y).ranking()
    ...
    smote_lr_pofb = PerformanceMeasure(
        testing_data_y, smote_lr_pred_y).PofB20()
    smote_lr_pofd = PerformanceMeasure(
        testing_data_y, smote_lr_pred_y).PofD20()
    smote_lr_ranking = PerformanceMeasure(
        testing_data_y, smote_lr_pred_y).ranking()
    ...
    smote_brr_pofb = PerformanceMeasure(
        testing_data_y, smote_brr_pred_y).PofB20()
    smote_brr_pofd = PerformanceMeasure(
        testing_data_y, smote_brr_pred_y).PofD20()
    smote_brr_ranking = PerformanceMeasure(
        testing_data_y, smote_brr_pred_y).ranking()
...
if __name__ == '__main__':
    ...
    for dataset, filename in Processing().import_single_data():
        ...
        lr_ranking_list = []
        brr_ranking_list = []
        rus_ltr_ranking_list = []
        rus_rs_ranking_list = []
        rus_dtr_ranking_list = []
        rus_lr_ranking_list = []
        rus_brr_ranking_list = []
        smote_ltr_ranking_list = []
        smote_rs_ranking_list = []
        smote_dtr_ranking_list = []
        smote_lr_ranking_list = []
        smote_brr_ranking_list = []
        ...
        # ranking
        csrs_ranking_average = sum_cols(csrs_ranking_list)
        irsvm_ranking_average = sum_cols(irsvm_ranking_list)
        svm_ranking_average = sum_cols(svm_ranking_list)
        ltr_ranking_average = sum_cols(ltr_ranking_list)
        rs_ranking_average = sum_cols(rs_ranking_list)
        dtr_ranking_average = sum_cols(dtr_ranking_list)
        lr_ranking_average = sum_cols(lr_ranking_list)
        brr_ranking_average = sum_cols(brr_ranking_list)
        rus_ltr_ranking_average = sum_cols(rus_ltr_ranking_list)
        rus_rs_ranking_average = sum_cols(rus_rs_ranking_list)
        rus_dtr_ranking_average = sum_cols(rus_dtr_ranking_list)
        rus_lr_ranking_average = sum_cols(rus_lr_ranking_list)
        rus_brr_ranking_average = sum_cols(rus_brr_ranking_list)
        smote_ltr_ranking_average = sum_cols(smote_ltr_ranking_list)
        smote_rs_ranking_average = sum_cols(smote_rs_ranking_list)
        smote_dtr_ranking_average = sum_cols(smote_dtr_ranking_list)
        smote_lr_ranking_average = sum_cols(smote_lr_ranking_list)
        smote_brr_ranking_average = sum_cols(smote_brr_ranking_list)
